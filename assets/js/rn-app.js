...
//           console.log(response);
            if (response.data.hasOwnProperty("labels") && response.data.hasOwnProperty("style") ) {
...
newCategory = candidateBeer.category;
...
//  console.log(array);
   ...
   let beerId = label.id;
   databaseOne.ref("/categories").push(candidateBeer);
   console.log(label);
